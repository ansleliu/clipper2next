...
[[nodiscard]] auto can_return_direct_convex_offset(
...
[[nodiscard]] auto can_return_direct_simple_offset(
    const std::vector<offset_group>& groups,
...
[[nodiscard]] auto offset_groups_in_range(
    const std::vector<offset_group>& groups) noexcept -> bool;
...
[[nodiscard]] auto calc_solution_capacity(
    const std::vector<offset_group>& groups) -> std::size_t;
[[nodiscard]] auto check_reverse_orientation(
    const std::vector<offset_group>& groups) -> bool;
